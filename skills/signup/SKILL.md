...
- **소셜 로그인**: 카카오·네이버 간편가입이 전환에 유리합니다(국내 사용자 친숙). 애플·구글을 병행합니다.
- **본인인증**: 필요한 서비스만 휴대폰 본인인증을 도입합니다(과도한 인증은 이탈 유발).
- **만 14세 미만**은 법정대리인 동의가 필요합니다(PIPA). 필수/선택 동의 항목을 분리하고 마케팅 수신 동의는 선택으로 둡니다.
- 동의·약관 UX는 전환과 규제(PIPA·정보통신망법, 현재 기준 확인 필요)의 균형을 맞춥니다.
